...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (!document.querySelector('.bottom-nav')) {
    ...
    const isModules = currentPath.includes('lesson') || currentPath.includes('exercise') || currentPath.includes('videos');
    const isResources = currentPath.includes('resources');
    const isLibrary = currentPath.includes('learn');
    ...
    bottomNav.innerHTML = `
      <div class="bottom-nav-inner">
        ...
        <a href="resources.html" class="bottom-nav-item ${isResources ? 'active' : ''}">
          <svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 19a2 2 0 01-2-2V7a2 2 0 012-2h4l2 2h4a2 2 0 012 2v1M5 19h14a2 2 0 002-2v-5a2 2 0 00-2-2H9a2 2 0 00-2 2v5a2 2 0 01-2 2z"/></svg>
          <span>Resources</span>
        </a>
        <a href="learn.html" class="bottom-nav-item ${isLibrary ? 'active' : ''}">
